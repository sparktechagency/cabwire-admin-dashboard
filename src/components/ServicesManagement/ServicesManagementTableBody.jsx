...
import ViewDetailsModal from "../CategoryManagement/ViewDetailsModal";
  ...
  return (
    <>
      ...
      >
        ...
        <ServicesViewDetailsModal isOpen={viewdetailsModalVisible} onClose={() => setViewdetailsModalVisible(false)} modalTitle="Services"
        imageAlt="Institution Information"
        details={[
          { label: "Service Name", value: "Service One" },
          { label: "Base Price", value: "$50" },
          { label: "Rate Per Km ($)", value: "$0.50" },
          { label: "Highest Hour", value: "20" }
        ]} />

       <ServicesManagementModal mode="edit" visible={editModalVisible} onCancel={() => setEditModalVisible(false)} />
    </>
  );
};
